                ...
                <div class="login-card row w-75 px-5 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="action-buttons row col-md-12 my-3">
                        <div class="col-sm-6 p-0 pe-sm-3 mb-2">
                            <a href="perfis.php" class="btn button two w-100 py-3 fw-bold border-0">LOGIN</a>
                        </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                        ...
                        <form action="inserrirperfil.php">
                            <div class="row">
                                <div class="mb-3 col-sm-12 d-flex flex-column">
                                    <label for="inputProfileName">Nome</label>
                                    <input type="text" class="form-control" name="inputProfileName" id="inputProfileName">
                                </div>

                                <div class="mb-3 col-sm-6 d-flex flex-column">
                                    <label for="inputProfileEmail">Email</label>
                                    <input type="email" class="form-control" name="inputProfileEmail" id="inputProfileEmail">
                                </div>

                                <div class="mb-3 col-6">
                                    <label for="inputProfilePassword">Senha</label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary cancel-btn fw-bold" data-bs-dismiss="modal">CANCELAR</button>
                        <button type="button" class="btn btn-primary save-btn fw-bold">SALVAR</button>
                    </div>
                </div>
            </div>
        </div>
